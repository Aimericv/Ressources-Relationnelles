...
return [
    ...
    'app_catalogue' => [[], ['_controller' => 'App\\Controller\\CatalogueController::catalogue'], [], [['text', '/catalogue']], [], [], []],
    ...
    'app_base' => [[], ['_controller' => 'App\\Controller\\HomeController::base'], [], [['text', '/base']], [], [], []],
    'app_homepage' => [[], ['_controller' => 'App\\Controller\\HomeController::post'], [], [['text', '/']], [], [], []],
    ...
    'app_post_actions' => [['id'], ['_controller' => 'App\\Controller\\PostController::postActions'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post/post']], [], [], []],
    'app_post_detail' => [['id'], ['_controller' => 'App\\Controller\\PostController::postDetail'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post/post']], [], [], []],
    ...
    'app_other_user' => [['id'], ['_controller' => 'App\\Controller\\UserController::otherUser'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/user']], [], [], []],
