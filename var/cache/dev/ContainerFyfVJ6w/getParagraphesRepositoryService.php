 ...
 */
class getParagraphesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParagraphesRepository' shared autowired service.
     *
     * @return \App\Repository\ParagraphesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParagraphesRepository.php';

        return $container->privates['App\\Repository\\ParagraphesRepository'] = new \App\Repository\ParagraphesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
