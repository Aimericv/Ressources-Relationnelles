 ...
 */
class getRepostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RepostRepository' shared autowired service.
     *
     * @return \App\Repository\RepostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RepostRepository.php';

        return $container->privates['App\\Repository\\RepostRepository'] = new \App\Repository\RepostRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
