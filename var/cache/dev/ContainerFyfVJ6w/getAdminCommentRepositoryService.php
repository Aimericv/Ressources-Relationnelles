 ...
 */
class getAdminCommentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdminCommentRepository' shared autowired service.
     *
     * @return \App\Repository\AdminCommentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdminCommentRepository.php';

        return $container->privates['App\\Repository\\AdminCommentRepository'] = new \App\Repository\AdminCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
