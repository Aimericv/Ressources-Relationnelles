 ...
 */
class getCommentResponseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentResponseRepository' shared autowired service.
     *
     * @return \App\Repository\CommentResponseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentResponseRepository.php';

        return $container->privates['App\\Repository\\CommentResponseRepository'] = new \App\Repository\CommentResponseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
