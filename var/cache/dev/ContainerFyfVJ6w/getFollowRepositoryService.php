 ...
 */
class getFollowRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FollowRepository.php';

        return $container->privates['App\\Repository\\FollowRepository'] = new \App\Repository\FollowRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
