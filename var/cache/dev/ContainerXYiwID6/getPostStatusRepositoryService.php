 ...
 */
class getPostStatusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostStatusRepository' shared autowired service.
     *
     * @return \App\Repository\PostStatusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostStatusRepository.php';

        return $container->privates['App\\Repository\\PostStatusRepository'] = new \App\Repository\PostStatusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
