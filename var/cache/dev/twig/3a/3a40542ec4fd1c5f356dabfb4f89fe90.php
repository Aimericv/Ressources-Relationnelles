...
class __TwigTemplate_97c0b9e6a630b5033588b9535e62599f extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "</textarea>
            ...
            <div>
                ...
                <select name=\"category\" id=\"category\">
                    <option value=\"game\" ";
        // line 25
        if ((array_key_exists("post", $context) && (twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 25, $this->source); })()), "type", [], "any", false, false, false, 25) == "game"))) {
            echo "selected";
        }
        echo ">Jeux</option>
                    <option value=\"event\" ";
        // line 26
        if ((array_key_exists("post", $context) && (twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 26, $this->source); })()), "type", [], "any", false, false, false, 26) == "event"))) {
            echo "selected";
        }
        echo ">Évènements</option>
                    <option value=\"well-being\" ";
        // line 27
        if ((array_key_exists("post", $context) && (twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 27, $this->source); })()), "type", [], "any", false, false, false, 27) == "well-being"))) {
            echo "selected";
        }
        echo ">Bien-être</option>
                </select>                
            </div>
            <div>
...
";
    ...
    {
        return array (  262 => 5,  255 => 4,  245 => 77,  232 => 71,  228 => 69,  222 => 67,  216 => 65,  214 => 64,  209 => 61,  206 => 60,  193 => 57,  182 => 56,  177 => 55,  175 => 54,  172 => 53,  169 => 52,  156 => 47,  139 => 46,  134 => 45,  132 => 44,  113 => 32,  103 => 27,  97 => 26,  91 => 25,  81 => 20,  70 => 16,  63 => 11,  60 => 4,  53 => 3,  36 => 1,);
    }
    ...
    <main class=\"container\">
        <section id=\"form-post\">
            ...
            <div>
                <label for=\"category\">Catégorie de la Ressource</label>
                <select name=\"category\" id=\"category\">
                    <option value=\"game\" {% if post is defined and post.type == \"game\" %}selected{% endif %}>Jeux</option>
                    <option value=\"event\" {% if post is defined and post.type == \"event\" %}selected{% endif %}>Évènements</option>
                    <option value=\"well-being\" {% if post is defined and post.type == \"well-being\" %}selected{% endif %}>Bien-être</option>
                </select>                
            </div>
            <div>
                <label for=\"address\">Ou se trouve votre ressource ?</label>
