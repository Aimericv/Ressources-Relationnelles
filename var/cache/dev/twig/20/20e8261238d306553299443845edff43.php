...
class __TwigTemplate_c8b90684b6d40de95fcedf91062740cd extends Template
{
    private $source;
    private $macros = [];
    ...
    <main class=\"container\">
        ...
        if ( !twig_test_empty((isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 29, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                ...
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["post"], "type", [], "any", false, false, false, 48), "name", [], "any", false, false, false, 48), "html", null, true);
                echo "</p>
