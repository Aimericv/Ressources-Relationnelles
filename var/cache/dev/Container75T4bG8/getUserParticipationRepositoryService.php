 ...
 */
class getUserParticipationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserParticipationRepository' shared autowired service.
     *
     * @return \App\Repository\UserParticipationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserParticipationRepository.php';

        return $container->privates['App\\Repository\\UserParticipationRepository'] = new \App\Repository\UserParticipationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
